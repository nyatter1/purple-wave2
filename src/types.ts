...
export interface UserProfile {
  ...
  spotify_listening_enabled?: boolean;
  spotify_visibility?: 'everyone' | 'friends' | 'only_me';
  spotify_track?: string;
  spotify_artist?: string;
  spotify_album_art?: string;
  spotify_is_playing?: boolean;
  spotify_last_updated?: number;
  spotify_access_token?: string;
  spotify_refresh_token?: string;
  spotify_token_expires_at?: number;
  spotify_disabled?: boolean;
...
export interface PrivateMessage {
  ...
  created_at: string;
  is_read: boolean;
  type: 'text' | 'image' | 'voice' | 'paint' | 'dice' | 'coin';
  dice_result?: number;
  dice_sides?: number;
  coin_result?: string;
}
